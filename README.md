...
- MacOS stuff:
	* Launchers: [Leaderkey](https://github.com/mikker/LeaderKey.app) and [Raycast](https://www.raycast.com/)
	* Keyboard navigation: [Homerow](https://www.homerow.app/) and [mouseless](https://mouseless.click/)
